...
from logging_client import LoggingHttpClient

# noinspection PyUnresolvedReferences
from .logging_default_config import (  # noqa: F401
...
# noinspection PyUnresolvedReferences
from .logging_hooks import set_custom_request_logging_hook, set_custom_response_logging_hook  # noqa: F401


def create(reusable_session: bool = True, logger: logging.Logger = logging.getLogger()) -> LoggingHttpClient:
    """
...
def delete(url: str, **kwargs) -> Response:
    ...
    :return: A new LoggingHttpClient instance.
    """
    yield create(reusable_session=False).delete(url, **kwargs)
